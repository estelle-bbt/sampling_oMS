...
# SEM with pre- and post-poll process
...
# SEM for males with flower

**For the low treatment :**

```{r,echo=FALSE,warning=FALSE,message=FALSE}
targets::tar_load(piecewisemales_low_combi1_flower)
piecewisemales_low_combi1_flower$plot
piecewisemales_low_combi1_flower$summary
```

**For the medium treatment :**

```{r,echo=FALSE,warning=FALSE,message=FALSE}
targets::tar_load(piecewisemales_medium_combi1_flower)
piecewisemales_medium_combi1_flower$plot
piecewisemales_medium_combi1_flower$summary
```

**For the high treatment :**

```{r,echo=FALSE,warning=FALSE,message=FALSE}
targets::tar_load(piecewisemales_high_combi1_flower)
piecewisemales_high_combi1_flower$plot
piecewisemales_high_combi1_flower$summary
```
# SEM including visit proxies
...
piecewisemales_low_combi1_visits$dsep
```
...
targets::tar_load(piecewisemales_medium_combi1_visits)
piecewisemales_medium_combi1_visits$plot
piecewisemales_medium_combi1_visits$summary
piecewisemales_medium_combi1_visits$dsep
```
...
targets::tar_load(piecewisemales_high_combi1_visits)
piecewisemales_high_combi1_visits$plot
piecewisemales_high_combi1_visits$summary
piecewisemales_high_combi1_visits$dsep
```
...
targets::tar_load(piecewisefemales_low_combi1_visits)
piecewisefemales_low_combi1_visits$plot
piecewisefemales_low_combi1_visits$summary
piecewisefemales_low_combi1_visits$dsep
```
...
targets::tar_load(piecewisefemales_medium_combi1_visits)
piecewisefemales_medium_combi1_visits$plot
piecewisefemales_medium_combi1_visits$summary
piecewisefemales_medium_combi1_visits$dsep
```
...
targets::tar_load(piecewisefemales_high_combi1_visits)
piecewisefemales_high_combi1_visits$plot
piecewisefemales_high_combi1_visits$summary
piecewisefemales_high_combi1_visits$dsep
```
