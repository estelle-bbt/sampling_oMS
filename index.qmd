...
## With ~ post-poll process

For males, we estimate the paternity share by excluding selfing in order to be consistant
...
For females, post-poll process are more difficult to define: the diversity of sexual partners
that had reached ovules matter (?) but here we define post-poll as the partner ability to fertilize ovules
("from the female point of view, to which point she has gathered a good team which score a lot of points")
but note that we did not categorize this as as post-poll process in the abundance paper
)
